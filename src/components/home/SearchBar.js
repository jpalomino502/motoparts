    ...
    <div className="mx-auto mb-4 lg:mt-8">
      <div className="bg-gradient-to-r from-[#ff0000] to-[#d70000] rounded-lg shadow-md overflow-hidden">
        <div className="p-4 sm:p-6">
          <div
            className={`flex justify-between items-center text-white text-lg sm:text-xl font-bold text-center ${isMobile ? "cursor-pointer" : ""}`}
            ...
            <>
              <div className="flex flex-wrap gap-4 justify-between mb-2">
                {Object.keys(filters).map((filterKey, index) => {
                  ...
                  return (
                    isVisible && (
                      <div key={filterKey} className="relative bg-white flex-1 min-w-[150px]">
                        {/* Label added here */}
                        <label
                          htmlFor={filterKey}
